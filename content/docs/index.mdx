...
| Dimension | Metric | Feature Space | Direction | Documentation |
| :--- | :--- | :--- | :--- | :--- |
...
<Cards>
  <Card title="Single Image" href="/single-image/aesthetic" description="Evaluate standalone aesthetic appeal, prompt compliance, and facial identity preservation." />
...
<Accordions>
  <Accordion title="Lazy Loading Model Weights">
  ...
  <Accordion title="Strict Spatial Alignment Verification">
  ...
  <Accordion title="Hardware Acceleration Across Platforms">
